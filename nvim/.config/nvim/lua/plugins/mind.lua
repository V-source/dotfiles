return {
    ...
    require('mind').setup({
      ...
      ui = {
        ...
        icon_preset = {
          ...
          { ' ', 'Uncheck, empty square or backlog, pending' },
  ...
  -- vim.keymap.set('n', "<leader>om", ":MindOpenSmartProject<CR>", { silent = true }),
  -- vim.keymap.set('n', "<leader>xm", ":MindClose<CR>", { silent = true }),
  -- vim.keymap.set('n', "<leader>rm", ":MindReloadState<CR>", { silent = true }),
